...
Your full role, routing rules, and workflow live in your system prompt (`$agents_dir/issue-team-pm.md`). That file is the single source of truth — read it first and follow it.
