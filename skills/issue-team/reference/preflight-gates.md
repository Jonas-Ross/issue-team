...
Loaded by SKILL.md Step 3.5. Three cheap checks run against the issue before `TeamCreate`. None auto-aborts — each surfaces a question to the user when it fires. If the user waves it off, proceed.
