...
Loaded by SKILL.md Step 6c. The `Model hint:` line in the approved spec picks the default dev/QA tier. This reference lists the domains where Haiku is unsafe even when the spec looks mechanical.
